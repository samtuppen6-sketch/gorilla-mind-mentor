...
export const PRACTICE_REGISTRY: GuidedPractice[] = [
  ...
  // -------------------------------------------------------------------------
  {
    ...
    disciplinePoints: 30,
    dailyActionKey: "breathworkCompleted",
    recommendedWhen: ["morning activation", "energised state", "pre-training", "strong sleep", "attack the day"],
    avoidWhen: ["in water", "driving", "poor sleep", "anxiety spike", "pregnancy", "cardiac condition", "seizure history"],
    safetyNotes: [
    ...
    completionRules: TIMED_RULES,
    description: "Short morning activation: sharp, controlled nasal breathing to wake the system and turn energy into action.",
    instructionText: "Seated. Spine tall. Phone away.\n\nFast but controlled nasal inhale 2 seconds.\nFull nasal exhale 2 seconds.\nKeep the rhythm even — do not hyperventilate.\n\nRepeat for 3 minutes. Stop if light-headed and switch to slow nasal breathing.",
