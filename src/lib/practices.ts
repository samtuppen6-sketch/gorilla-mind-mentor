...
export const PRACTICE_REGISTRY: GuidedPractice[] = [
  ...
  },
  {
    ...
    disciplinePoints: 30,
    dailyActionKey: "breathworkCompleted",
    recommendedWhen: ["evening shutdown", "anxious", "angry", "wired", "overwhelmed", "post-training downshift", "sleep wind-down", "late night"],
    avoidWhen: ["in water", "driving"],
    ...
    description: "Brings the system down, slows the stress response, and prepares you to switch off. Inhale 4 / Exhale 6, 15 rounds.",
    instructionText: "Lights low. Phone down.\n\nInhale through the nose for 4 seconds.\nExhale slowly through the mouth for 6 seconds.\n\n15 rounds. No breath holds.",
  ...
  // -------------------------------------------------------------------------
  // Breathwork Prescription Engine — protocol map IDs
  // -------------------------------------------------------------------------
  {
    ...
    category: "Breathwork",
    route: "BREATHWORK",
    routes: ["BREATHWORK", "MORNING_PROTOCOL", "MORNING_PROTOCOL_REQUEST", "BREATHWORK_MEDITATION_REQUEST"],
    subRoute: "ENERGISE",
    durationMinutes: 4,
    intensity: "moderate",
    disciplinePoints: 30,
    dailyActionKey: "breathworkCompleted",
    recommendedWhen: [
      "morning energy", "strong sleep", "pre-training activation",
      "low drive but not anxious", "confidence", "controlled focus",
      "attack-the-day state",
    ],
    avoidWhen: ["in water", "driving", "anxiety spike", "panic", "dizziness", "pregnancy", "cardiac condition", "seizure history"],
    safetyNotes: [
      "Do not perform in water or driving.",
      "Skip if pregnant, cardiac history, seizure history, or feeling dizzy.",
      "Stop immediately if light-headed.",
    ],
    placeholderAudioUrl: PLACEHOLDER_AUDIO,
    placeholderVisualUrl: PLACEHOLDER_VISUAL,
    practicePath: path("energising_breath_3min"),
    completionRules: TIMED_RULES,
    audioAssetId: "energising_breath_3min_audio",
    description: "Sharp morning activation: controlled 3-second nasal inhale, 3-second exhale. 20 rounds. Wakes the system, sharpens the body, turns energy into action.",
    instructionText: "Seated. Spine tall. Phone away.\n\nNasal inhale 3 seconds.\nExhale with control 3 seconds.\nNo holds. Keep the rhythm even — do not hyperventilate.\n\n20 rounds. Stop if light-headed and switch to slow nasal breathing.",
    primaryButtonLabel: "Start Energising Breath",
  },
  {
    id: "urge_reset_3min",
    title: "Urge Reset Breath",
    category: "Breathwork",
    route: "URGE_RESET",
    routes: ["URGE_RESET", "PROCESS_ADDICTION", "SOBRIETY_CRAVING", "BREATHWORK"],
    subRoute: "URGE",
    durationMinutes: 5,
    intensity: "low",
    disciplinePoints: 30,
    dailyActionKey: "breathworkCompleted",
    recommendedWhen: [
      "porn urge", "gambling urge", "substance urge", "alcohol craving",
      "scrolling loop", "binge impulse", "compulsive behaviour",
      "relapse risk", "feeling out of control",
    ],
    avoidWhen: ["self-harm ideation", "suicidal ideation"],
    safetyNotes: [
      "If urges involve self-harm or suicidal ideation: stop and contact a crisis line or emergency services immediately.",
    ...
    placeholderAudioUrl: PLACEHOLDER_AUDIO,
    placeholderVisualUrl: PLACEHOLDER_VISUAL,
    practicePath: path("urge_reset_3min"),
    completionRules: TIMED_RULES,
    audioAssetId: "urge_reset_3min_audio",
    description: "Short interrupt: create space between urge and action. Breaks the loop and hands control back.",
    instructionText: "Phone out of reach. Change rooms if you can.\n\nName it silently: 'this is an urge'.\nInhale nasally 4 seconds.\nExhale long through the mouth 8 seconds.\nNo holds. 12 rounds.\n\nDo not act on the urge during this session.",
    primaryButtonLabel: "Start Urge Reset",
  },
  {
    id: "identity_reset_breath_5min",
    title: "Identity Reset Breath",
    category: "Breathwork",
    route: "MISSED_DAY_REPAIR",
    routes: ["MISSED_DAY_REPAIR", "MISSED_MORNING", "IDENTITY_RESET", "BREATHWORK"],
    subRoute: "IDENTITY",
    durationMinutes: 5,
    intensity: "low",
    disciplinePoints: 30,
    dailyActionKey: "breathworkCompleted",
    recommendedWhen: ["missed days", "shame spiral", "low self-respect", "re-entry", "identity drift"],
    avoidWhen: [],
    safetyNotes: ["No shame. This is operator repair, not punishment."],
    placeholderAudioUrl: PLACEHOLDER_AUDIO,
    placeholderVisualUrl: PLACEHOLDER_VISUAL,
  ...
  },
  {
    ...
    category: "Breathwork",
    route: "RECOVERY_DAY",
    routes: ["RECOVERY_DAY", "LOW_READINESS", "POOR_SLEEP", "BREATHWORK"],
    subRoute: "RECOVERY",
    durationMinutes: 5,
    intensity: "low",
    disciplinePoints: 30,
    dailyActionKey: "breathworkCompleted",
    recommendedWhen: ["post-training", "fatigue", "nervous system recovery", "rest day", "sauna", "cold exposure", "long walks"],
    avoidWhen: ["in water", "driving"],
    safetyNotes: ["Nasal inhale only. Short 2-second hold. Stop if dizzy."],
    placeholderAudioUrl: PLACEHOLDER_AUDIO,
    placeholderVisualUrl: PLACEHOLDER_VISUAL,
    practicePath: path("recovery_breath_5min"),
    completionRules: TIMED_RULES,
    audioAssetId: "recovery_breath_5min_audio",
    description: "Post-training downshift. Signals safety to the body, lowers intensity, and starts recovery.",
    instructionText: "Lying down or seated. Quiet.\n\nNasal inhale 4 seconds.\nHold 2 seconds.\nSlow mouth exhale 8 seconds.\n\n10 rounds. The long exhale is the key — let the body come down.",
    primaryButtonLabel: "Start Recovery Breath",
  },
];
