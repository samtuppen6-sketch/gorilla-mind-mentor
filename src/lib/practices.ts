...
export const PRACTICE_REGISTRY: GuidedPractice[] = [
  ...
  },
  {
    ...
    disciplinePoints: 30,
    dailyActionKey: "breathworkCompleted",
    recommendedWhen: ["post-training", "fatigue", "nervous system recovery", "rest day"],
    avoidWhen: ["in water", "driving"],
    safetyNotes: ["Nasal only. No breath holds. Stop if dizzy."],
    placeholderAudioUrl: PLACEHOLDER_AUDIO,
    placeholderVisualUrl: PLACEHOLDER_VISUAL,
    practicePath: path("recovery_breath_5min"),
    completionRules: TIMED_RULES,
    description: "Signals safety to the body, lowers intensity, and helps the system recover.",
    instructionText: "Lying down or seated. Quiet.\n\nSlow nasal inhale 4 seconds.\nSlow nasal exhale 8 seconds.\nKeep the exhale twice the inhale.\n\nRepeat for 5 minutes. No breath holds.",
